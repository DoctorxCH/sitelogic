    ...
    <div class="max-w-md w-full space-y-6 bg-white p-8 rounded-2xl shadow-md border border-gray-100">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" id="email" required autocomplete="email" class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900" value="<?php echo e(old('email')); ?>">
            </div>
...
<?php /**PATH /var/www18/p50824/sitelogic.sk/web/resources/views/auth/login.blade.php ENDPATH**/ ?>